    ...
    <div className="App">
      <div className='Info'>
        <div className='Header'>
          <img src={logo} className={loaded ? 'logo' : 'logo-unloaded'} alt="alore logo" width='175'/> 
        </div>
        <h3>alore radio:</h3>
        <div className='iframe-container'>
          <iframe className='iframe-responsive' width="560" height="315" src="https://www.youtube.com/embed/2K-PCaqQWFM?si=NQ4GKOdTSgcT1DfK" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        </div>
        <h3>meet the team:</h3>
        <div className='Team'>
        ...
        <div className='Socials'>
            <a className={loaded ? "socialIcon" : "socialIcon-unloaded"} href="https://www.instagram.com/forthealore/" ><FontAwesomeIcon size='sm' icon={faInstagram}/></a>
            <a className={loaded ? "socialIcon" : "socialIcon-unloaded"} href="https://www.tiktok.com/@forthealore" ><FontAwesomeIcon size='sm' icon={faTiktok}/></a>
            <a className={loaded ? "socialIcon" : "socialIcon-unloaded"} href="https://on.soundcloud.com/9kooV" ><FontAwesomeIcon icon={faSoundcloud} size='sm'/></a>
            <a className={loaded ? "socialIcon" : "socialIcon-unloaded"} href="https://www.youtube.com/@forthealore" ><FontAwesomeIcon icon={faYoutube} size='sm'/></a>
            <a className={loaded ? "socialIcon" : "socialIcon-unloaded"} href="https://discord.gg/HW2qtJvk8J" ><FontAwesomeIcon icon={faDiscord} size='sm'/></a>
          </div>
      </div>
    </div>
  );
