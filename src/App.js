			...
			<div className="App">
				...
				<div className="site-body">
					...
					<div className="promo">
						<a href="https://www.eventbrite.com/e/alore-presents-the-klm-experience-tickets-899270210407?aff=oddtdtcreator">
							<div className="blurred-promo-img">
								<img src="https://res.cloudinary.com/dyyurflew/image/upload/f_auto,q_auto/eteu6ib69cczx9esqyzz" alt="alore LA promo flyer" width="720" height="898" className="promo-img"/>
							</div>
						</a>
					...
					<div className="iframe-container">
						<iframe className="iframe-responsive" width="560" height="315" src="https://www.youtube.com/embed/24CgikCK4uk?si=o5p5WX_YXrK4dFzx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen loading="lazy"></iframe>
					</div>
					<h2>meet the team:</h2>
					<div className="Team">
						<TeamCard
